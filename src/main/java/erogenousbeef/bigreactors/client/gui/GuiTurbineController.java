...
public class GuiTurbineController extends BeefGuiBase {
	...
	public void initGui() {
		...
		btnActivate = new GuiIconButton(0, guiLeft + 4, guiTop + 144, 18, 18, ClientProxy.GuiIcons.getIcon("On_off"), new String[] { TextFormatting.AQUA + "Activate Turbine", "", "Enables flow of intake fluid to rotor."});
		btnDeactivate = new GuiIconButton(1, guiLeft + 24, guiTop + 144, 18, 18, ClientProxy.GuiIcons.getIcon("Off_off"), new String[] { TextFormatting.AQUA + "Deactivate Turbine", "", "Disables flow of intake fluid to rotor."});
